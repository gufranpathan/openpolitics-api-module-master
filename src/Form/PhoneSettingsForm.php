...
/**
 * This forms handles the phoneapp auth0 configurations.
 */
class PhoneSettingsForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'auth0_phone_settings_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->configFactory()->get('jutaav_civicrm_access.phoneapp.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config = $this->configFactory()->getEditable('jutaav_civicrm_access.phoneapp.settings');
